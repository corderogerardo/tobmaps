 ...
 * Emails Module
 * @module    Emails
 * @description Client side Meteor for GMAIL Emails Table Views Template.
 *
 * Here you will find the methods for blaze templates:
 * 1. gmailTables Template Methods:
 * 1.1 onRendered: Loads the footable() jquery function.
 * 1.2 Helpers:
 * 		emails: Search all the GMAIL emails.userCanEdit
...
/**
 * @summary Meteor Blaze Template gmailTables Events

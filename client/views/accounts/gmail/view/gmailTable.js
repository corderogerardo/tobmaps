 ...
 * 1. gmailTables Template Methods for:
 * 1.1 onRendered: Loads the footble() jquery functions.
 * 1.2 Helpers:
 *     emails: Search all the gmail emails where the type of domain be gmail.com.
 ...
 * @method check() from Meteor is used to validate data integrity and be sure that the data type is the same from the colecction.
 */
 ...
 * Here we create an event handler to listen when the user click on button to delete an account.

 ...
 * @memberOf Emails
 * @name  OutlookTable
 * @locus client/views/emails/outlook/view
 ...
 * Meteor Blaze Template outlookTable Helpers
 ...
 * Meteor Blaze Template outlookTable Events
 * @param {event} delete-email
 * "click .js-delete-email" Here we create an event handler to listen when user click on button to delete an email.
 ...
 * @param {String} this._id refer to email._id
 * 
 */
